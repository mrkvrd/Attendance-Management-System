...
class LoginFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.LoginLabel = ctk.CTkLabel(self, text="ADMIN LOGIN", font=("Arial", 25, "bold"), text_color="#545454")
        self.LoginLabel.grid(row=0, column=0, sticky="nwe", pady=25)

        self.UserEntry = ctk.CTkEntry(self, placeholder_text="Enter Username", height=40, placeholder_text_color="#545454", border_width=2,
